            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-on-surface-variant">
                        Gerencie as informações e permissões da manutenção no sistema SIGMAR.
                    </p>
                </div>
            </div>
      ...
      <div class="grid grid-cols-12 gap-4 md:gap-gutter">
        <div class="col-span-12 lg:col-span-8 space-y-4 md:space-y-gutter">
          ...
          <section
            ...
            <div class="flex items-center gap-3 mb-6 md:mb-8">
              <div class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center flex-shrink-0">
                <span class="material-symbols-outlined text-on-primary">settings_input_component</span>
              </div>
              <h4 class="font-h3-card-title text-on-surface">Detalhes da Manutenção</h4>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Nome da Manutenção</p>
              ...
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Tipo de Máquina</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars($ordem->getTipo()) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Prioridade</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars($ordem->getPrioridade()) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Status da Manutenção</p>
                <p class="font-body-main text-on-surface">
                    <?= htmlspecialchars(ucfirst($ordem->getStatus())) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Data Agendada</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars($ordem->getDataAgendada()) ?>
                </p>
              </div>
              <br>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">ID do Técnico</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars($ordem->getIdUsuario()) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Técnico responsável</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars($ordem->getNomeTecnico()) ?>
                </p>
              </div>
            </div>
          </section>
          ...
          <section
            ...
            <div class="flex items-center gap-3 mb-6 md:mb-8">
              <div class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center flex-shrink-0">
                <span class="material-symbols-outlined text-on-primary">settings</span>
              </div>
              <h4 class="font-h3-card-title text-on-surface">Informações da Máquina</h4>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">ID da Máquina</p>
                <p class="font-body-main text-on-surface">
                    <?= htmlspecialchars($ordem->getIdMaquina()) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Nome da Máquina</p>
                <p class="font-body-main text-on-surface break-all">
              ...
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Tipo de Máquina</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars($ordem->getTipoMaquina()) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Status da Máquina</p>
                <p class="font-body-main text-on-surface">
                    <?= htmlspecialchars(ucfirst($ordem->getStatusMaquina())) ?>
                </p>
              </div>
            </div>
          </section>

          <!-- Informações de quando a Manutenção for Executada -->

          <?php if($manutencao): ?>
            <section class="bg-surface-container-lowest p-6 md:p-card-inner-padding rounded-xl border border-outline-variant/30 shadow-sm relative overflow-hidden">
                <div class="flex items-center gap-3 mb-6 md:mb-8">
                <div class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center flex-shrink-0">
                    <span class="material-symbols-outlined text-on-primary">description</span>
                </div>
                <h4 class="font-h3-card-title text-on-surface">Relatório da Manutenção</h4>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                <div class="space-y-1">
                    <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Descrição do Serviço</p>
                    <p class="font-body-main text-on-surface">
                ...
                <div class="space-y-1">
                    <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Observações</p>
                    <p class="font-body-main text-on-surface break-all">
                        <?= htmlspecialchars($manutencao->getObservacoes()) ?>
                    </p>
                </div>

                <div class="space-y-1">
                    <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Data Início</p>
                    <p class="font-body-main text-on-surface break-all">
                        <?= htmlspecialchars($ordem->getDataInicio()) ?>
                    </p>
                </div>

                <div class="space-y-1">
                    <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Data Conclusão</p>
                    <p class="font-body-main text-on-surface break-all">
                        <?= htmlspecialchars($ordem->getDataConclusao()) ?>
                    </p>
                </div>
                </div>
            </section>
