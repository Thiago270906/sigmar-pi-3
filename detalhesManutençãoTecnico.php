    ...
    <main class="flex-1 p-4 md:p-8 space-y-8 overflow-y-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-on-surface-variant">
                        Visualize as informações completas da ordem para realização da manutenção.
                    </p>
                </div>
            </div>
      ...
      <div class="grid grid-cols-12 gap-4 md:gap-gutter">
        <div class="col-span-12 lg:col-span-8 space-y-4 md:space-y-gutter">
          ...
          <!-- Card: Informações da Manutenção -->
          <section
            ...
            <div class="flex items-center gap-3 mb-6 md:mb-8">
              ...
              <h4 class="font-h3-card-title text-on-surface">Informações da Manutenção</h4>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
              ...
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Ocorrência</p>
              ...
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Tipo de Manutenção</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars(ucfirst($ordem->getTipo())) ?>
                </p>
              </div>

              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Descrição</p>
                <p class="font-body-main text-on-surface">
                    
                    <?php if($ordem->getDescricao()): ?>
              ...
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Nível de Prioridade</p>
                <p class="font-body-main text-on-surface break-all">
                    <?= htmlspecialchars(ucfirst($ordem->getPrioridade())) ?>
                </p>
              </div>
          ...
          <section
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
              ...
              <div class="space-y-1">
                <p class="text-caption text-on-tertiary-container font-bold uppercase tracking-wider">Status</p>
                <p class="font-body-main text-on-surface">
          ...
          <div class="flex gap-3 justify-end">
                    ...
                    <a class="px-6 py-2.5 font-medium text-on-surface-variant hover:text-primary transition-colors" href="index.php?acao=manutencoes">
                        Voltar
                    </a>
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <form 
                                ...
                                method="POST"
                            >
                                <button class="px-8 py-2.5 bg-primary text-on-primary rounded-lg font-bold shadow-sm hover:opacity-90 hover:shadow-md transition-all flex items-center gap-2" type="submit">
                                    Iniciar Manutenção
                                </button>
                            </form>
